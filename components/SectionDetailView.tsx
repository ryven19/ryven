              ...
              <div className="md:w-2/5 p-5 sm:p-8 flex flex-col justify-between bg-white border-t md:border-t-0 md:border-l border-[rgba(0,0,0,0.06)]">
                ...
                <div className="mt-8 pt-4 border-t border-[rgba(0,0,0,0.06)]">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="btn-shimmer block w-full text-center font-mono text-xs uppercase tracking-wider bg-bone text-ink py-3 hover:opacity-90 transition-opacity duration-300 relative"
                  >
                    <span className="relative z-[1]">Contact us</span>
                  </a>
                </div>
